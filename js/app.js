        ...
        <div class="card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="${
                      this.img
                    }" class="img-fluid rounded-start" alt="${this.alt}">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">${this.nombre}</h5>
                        <p class="card-text">Cantidad:
                        <button class="btn btn-cantidad" id="disminuir-${
                          this.id
                        }"><i class="fa-solid fa-minus"></i></button>
                        ${this.cantidad > 0 ? this.cantidad : "Agotado"}
                        <button class="btn btn-cantidad" id="aumentar-${
                          this.id
                        ...
                        <button class="btn-eliminar mt-5" id = "eliminarprod-${
                          this.id
                        }">
...
class ProductoController {
  ...
  mostrarEnDOM(categoriaSeleccionada) {
    ...
    const cantidadEnCarrito = carrito.listaCarrito.reduce(
...
class Carrito {
  ...
  agregar(productoAgregar) {
    ...
    let existe = this.listaCarrito.find(
    ...
    finalizar_compra.addEventListener("click", () => {
      if (this.listaCarrito.length > 0) {
        ...
        Swal.fire({
          ...
          icon: "warning",
          title:
            "Parece que tu carrito está un poco solitario. 🛒🌟 Dale vida añadiendo algunos productos geniales!",
          showConfirmButton: false,
          timer: 2000,
        });
      }
